module.exports = {
    ...
    execute(message, args, app) {
        ...
        .setTitle('Dashboard')
        .setURL("https://discord.com/api/oauth2/authorize?client_id=710067353227886612&redirect_uri=http%3A%2F%2F192.168.43.243%3A8000&response_type=token&scope=identify%20guilds")
        .setDescription([
            'commands:',
            '',
